    ...
    public static class IP_Airplane_SetupTools 
    {
        public static void BuildDefaultAirplane(string aName)
        {
            ...
            if(controller)
            {
                ...
                GameObject defaultAirplane = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/Airplane/Art/Objects/IndiePixel_Airplanes/F4U_Corsair/F4U_WithCockPit_Geo.FBX", typeof(GameObject));
                if (defaultAirplane)
                {
