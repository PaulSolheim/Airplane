    ...
    public static class IP_Airplane_SetupTools 
    {
        public static void BuildDefaultAirplane(string aName)
        {
            ...
            if(controller)
            {
                ...
                GameObject defaultAirplane = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/Airplane/Art/Objects/IndiePixel_Airplanes/Indie-Pixel_Airplane/IndiePixel_Airplane.fbx", typeof(GameObject));
                if (defaultAirplane)
                {
